    ...
    <div className="grid md:grid-cols-2 gap-8">
      <div className="rounded-2xl bg-bgAlt overflow-hidden">
        <div className="relative h-48 w-full">
          <Image src="/property-brief.jpg" alt="Brief report" fill className="object-cover" />
        </div>
        <div className="p-8">
      ...
      <div className="rounded-2xl bg-bgAlt overflow-hidden">
        <div className="relative h-48 w-full">
          <Image src="/property-address.jpg" alt="Address report" fill className="object-cover" />
        </div>
        <div className="p-8">
